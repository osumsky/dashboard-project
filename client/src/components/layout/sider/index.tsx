            ...
            >
              <ListItemIcon
                sx={{
                  justifyContent: 'center',
                  minWidth: 36,
                  color: isSelected ? '#fff' : '#808191', // color: 'primary.contrastText',
                }}
              >
                {icon ?? <ListOutlined />}
              </ListItemIcon>
        ...
        >
          <ListItemIcon
            sx={{
              justifyContent: 'center',
              minWidth: 36,
              color: '#808191', //color: 'primary.contrastText',
              marginLeft: '8px',
              marginRight: '14px'
            }}
          >
      ...
      >
        <ListItemIcon
          sx={{
            justifyContent: 'center',
            minWidth: 36,
            color: '#808191', // 'primary.contrastText',
          }}
        >
          <Logout />
        </ListItemIcon>
      ...
      >
        <Drawer
          ...
          sx={{
            ...
            '& .MuiDrawer-paper': {
              width: 256,
              bgcolor: '#FCFCFC', //bgcolor: 'secondary.main',
            },
          }}
        >
          <Box
        ...
        >
          ...
          <Button
            sx={{
              background: '#475BE8', //background: 'rgba(0,0,0,.5)',
              color: 'primary.contrastText',
              textAlign: 'center',
              borderRadius: 0,
        ...
        <Box
          sx={{
            ...
            bgcolor: '#475be8', //bgcolor: 'secondary.main',
            zIndex: 1199,
            width: '36px',
          }}
        >
